...
phn = Image.open("R:\phone pe\phonepe-logo.png")
...
# TO GET THE DATA-FRAME OF AGGREGATED_TRANSACTION
...
for state in Agg_state_list:
    ...
    for year in Agg_yr:
        ...
        Agg_yr_list = os.listdir(cur_year)
        ...
        for file in Agg_yr_list:
            ...
            for z in A['data']['transactionData']:
                ...
                col1['Quater'].append(int(file.strip('.json')))
df_aggregated_transaction = pd.DataFrame(col1)


# TO GET THE DATAFRAME OF AGGREGATED_USER
        ...
        for file in Agg_yr_list:
            ...
            try:
                for w in B["data"]["usersByDevice"]:
                    ...
                    col2["Quater"].append(int(file.strip('.json')))
            except:
                pass
df_aggregated_user = pd.DataFrame(col2)


# TO GET THE DATA-FRAME OF MAP_TRANSACTION
    ...
    for year in Agg_yr:
        ...
        for file in Agg_yr_list:
            ...
            for x in C["data"]["hoverDataList"]:
                ...
                col3['Quater'].append(int(file.strip('.json')))
df_map_transaction = pd.DataFrame(col3)


# TO GET THE DATAFRAME OF MAP_USER
    ...
    for year in Agg_yr:
        ...
        for file in Agg_yr_list:
            ...
            for u in D["data"]["hoverData"].items():
                ...
                col4['Quater'].append(int(file.strip('.json')))
df_map_user = pd.DataFrame(col4)


# TO GET THE DATAFRAME OF TOP_TRANSACTION
    ...
    for year in Agg_yr:
        ...
        for file in Agg_yr_list:
            ...
            for z in E['data']['pincodes']:
                ...
                col5['Quater'].append(int(file.strip('.json')))
df_top_transaction = pd.DataFrame(col5)


# TO GET THE DATAFRAME OF TOP_USER
    ...
    for year in Agg_yr:
        ...
        for file in Agg_yr_list:
            ...
            for t in F['data']['pincodes']:
                ...
                col6['Quater'].append(int(file.strip('.json')))
...
SELECT = option_menu(
    menu_title = None,
    options = ["Home","Search","Basic insights","About"],
    icons =["house","search","house","bar-chart","toggles"],
    default_index=0,
...
if SELECT == "Home":
    ...
    col1.image(Image.open("R:\phone pe\phonepe-logo.png"),width = 500)
    with col1:
    ...
    with col2:
        st.video("C:/Users/rohit/Downloads/phonepe-introduction-steptodown.com.mp4")
if SELECT =="Search":
...
#creating functions for query search in sqlite to get the data
    ...
    if choice_topic=="Transaction-Type":
        ...
        with col1:
            st.subheader("TYPES OF TRANSACTION")
...
if SELECT == "About":
    col1,col2 = st.columns(2)
    with col1:
        st.video("C:/Users/rohit/Downloads/Introducing PhonePe Pulse.mp4")
        st.write("---")
        st.title("THE BEAT OF PHONEPE")
        st.write("---")
        st.subheader("Phonepe became a leading digital payments company")
        st.image(Image.open("R:\phone pe\phonepe-logo.png"), width=400)
        with open("C:/Users/rohit/Downloads/PhonePe_Pulse_BCG_report.pdf", "rb") as f:
            data = f.read()
        st.download_button("DOWNLOAD REPORT", data, file_name="annual report.pdf")
    with col2:
        st.image(Image.open("R:/phone pe/phonepe-logo.png"),width = 600)
        st.write("---")
